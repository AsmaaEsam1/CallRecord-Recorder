...
public class MainActivity extends AppCompatActivity {
    private MP3Recorder mRecorder = new MP3Recorder(Environment.getExternalStoragePublicDirectory("AudioRecorder")+"/test1.mp3");
...
//all premissins
    ...
    Button startRecoring,stopRecording;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String premissions : premission) {
            ...
            startRecoring = findViewById(R.id.start);
